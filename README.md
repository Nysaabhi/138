...
// Function to show the chat support overlay
    ...
    <div class="chat-support-content">
      ...
      <div class="contact-support" id="contactSupport">
        <div class="contact-support-header">
          ...
          <button class="refresh-button" onclick="refreshChatSupport()">
...
function getFAQsByCategory(category) {
  ...
  const faqs = {
    Grocery: [
      { id: 1, question: "How do I place an order?", answer: "You can place an order by visiting our website or using our mobile app." },
      { id: 2, question: "What payment methods do you accept?", answer: "We accept cash, credit/debit cards, and UPI payments." }
    ],
    Food: [
      { id: 3, question: "Do you offer delivery?", answer: "Yes, we offer delivery services to your location." },
      { id: 4, question: "Can I customize my order?", answer: "Yes, you can customize your order during the checkout process." }
    ],
    Electronics: [
      { id: 5, question: "What is your return policy?", answer: "You can return products within 30 days of purchase if they are unused and in original packaging." },
      { id: 6, question: "Do you offer warranty?", answer: "Yes, we offer a 1-year warranty on all electronics." }
    ]
  };
...
// Function to refresh chat support
function refreshChatSupport() {
  const faqList = document.getElementById('faqList');
  if (faqList) {
    faqList.innerHTML = renderFAQs(currentCategory);
  }
}
...
// Initialize chat search with debouncing
function initializeChatSearch() {
  const chatSearchInput = document.getElementById('chatSearchInput');
  if (chatSearchInput) {
